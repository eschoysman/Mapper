...
public class EMB_BuilderStep {
	...
	public void shouldReturnStringRappresentation() throws MappingException {
		...
		assertThat(em.toString()).matches(Pattern.compile("ElementMapper\\[elementMapper_id_\\d+?,Getter\\[id=\\d+?,name=getterName],Setter\\[id=\\d+?,name=setterName]]"));
	...
	public void shouldReturnElementMapper() throws MappingException {
		...
		assertThat(em.get().toString()).matches(Pattern.compile("ElementMapper\\[elementMapper_id_\\d+?,Getter\\[id=\\d+?,name=getterName],Setter\\[id=\\d+?,name=setterName]]"));
	}
