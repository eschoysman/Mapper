...
/**
 * Optional step of the EMBuilder that allow to specify a default value if the getter of the {@code From} step is null.<br>
 * Previous step: {@link From}<br>
 * Next step: {@link Transformer}
 * @author eschoysman
 *
...
public interface DefaultInput<IN,GETTER_OUT,SETTER_IN,OUT> extends Transformer<IN,GETTER_OUT,SETTER_IN,OUT> {
	 ...
	 * @return the next (optional) step of the EMBuilder: {@link Transformer}
	 * @see Transformer
	 */
