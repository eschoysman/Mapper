 ...
 * <li>{@code Consume}: (mandatory*) consume the result value of the transformation. Similar to {@code To} step but does not set any value.</li>
 * <li>{@code ElementMapperBuilder}: (mandatory) create the ElementMapper.</li>
 * </ol>
 * *: {@code Consume} and {@code To} are mutually exclusive.<br><br>
 ...
 * @see es.utils.mapper.factory.builder.Consume
