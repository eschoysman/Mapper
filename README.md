...
- [How does the mapper work?](#how-does-the-mapper-work)
...
<a href="lets-code"></a>
## Let's code!
Just before looking to the first example, there is a little prerequisite that we must follow: all destination class of a mapping must have at least the empty constructor, otherwise the `Mapper` will not be able to create a new instance to return. Maybe in the future this won't be absolutely required (see "[In the future](#in-the-future)" section, point 1)!
...
---
<a href="how-does-the-mapper-work"></a>
