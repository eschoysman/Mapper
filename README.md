...
[![Travis (.org) branch][build_badge]][build_link] [![coverage][coverage_badge]][coverage_link] [![GitHub][license_badge]][license_link]  ![GitHub top language][top_language_badge] ![GitHub code size in bytes][code_size_badge]
...
---
## Download
You can download the jar to include into you project [here][download_jar] (< 40 KB).
...
[download_jar]: https://github.com/eschoysman/Mapper/tree/master/jar/Mapper.jar
